...
contract XTNFT is Ownable {
        ...
        returns (uint256)
    {
        ...
        paymentToken(1).safeTransferFrom(msg.sender, _foreverLocker, _burnRate * numOfYear * getMintPrice()/ 1e20);
        ...
        external
    {
        ...
        if(_tokenForRegisterNFT == _tokenForMarketPlace)
            paymentToken(2).safeTransferFrom(msg.sender, _foreverLocker, _burnRate * nftNameMap[NFTName_]._salePrice/ 1e20);

...
contract XTNFT is ERC721URIStorage,  Ownable {
    ...
    string[] private _nameXTExt= [".aave", ".ada", ".algo", ".alt", ".atom", ".avax", ".bch", ".bnb", ".bsv", ".btc", ".cake", ".chz", ".dash", ".dcr", ".dot", ".egld", ".enj", ".eos", ".etc", ".eth", ".fil", ".flow", ".ftm", ".hbar", ".hnt", ".hot", ".icp", ".int", "iotx", ".kda", ".klay", ".ksm", ".link", ".luna", ".matic", ".mina", ".miota", ".mkr", ".near", ".neo", ".omg", ".one", ".qnt", ".qtum", ".rune", ".sc", ".sol", ".stx", ".theta", ".trx", ".uni", ".vet", ".waves", ".xdc", ".xem", ".xlm", ".xrp", ".xt", ".xtz"];
